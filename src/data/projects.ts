...
export const projects: Project[] = [
    {
        ...
        status: "live",
        detailDescription: "A browser-playable multiplayer prototype that pairs a Unity WebGL client with a purpose-built real-time service for room-based matches.",
        stackLabel: "Unity WebGL · TypeScript · WebSocket",
        actionLabel: "Play ChatroomWars",
        preview: {
            src: "assets/img/chatroomwars.webp",
            alt: "ChatroomWars READY screen showing the Hidden mode instructions on a chalkboard",
            caption: "Hidden mode · READY screen",
            width: 1280,
            height: 720,
        },
        highlights: [
            { icon: "fa-brands fa-unity", title: "Browser game client", detail: "A Unity WebGL build makes the complete client playable without a desktop install." },
            { icon: "fa-solid fa-users", title: "Rooms and matchmaking", detail: "Players choose usernames, join live rooms, and move from the workshop into matches." },
            { icon: "fa-solid fa-network-wired", title: "Realtime backend", detail: "A TypeScript WebSocket service routes compact MessagePack chat, position, and game packets." },
        ],
    },
    {
        id: "unreal-engine-5",
